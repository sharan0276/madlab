...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public Boolean insertEmployee(String eCode, String eName, String eGender, String eDept, long
            eSalary) {
    ...
    public Boolean updateEmployee(String eCode, String eName, String eGender, String eDept, long
            eSalary) {
        SQLiteDatabase DB = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("eName", eName);
